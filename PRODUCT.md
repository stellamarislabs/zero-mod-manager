...
Star Wars: Zero Company players who install packaged, Unreal plugin, UE4SS, and configuration mods on Windows or Linux/Proton. They need a dependable desktop tool that explains exactly what will change, preserves user-owned files, and makes recovery possible when a game path, runtime, archive, or update is invalid.
...
- Do not turn the utility into a decorative game launcher or marketing surface.
- Do not redesign familiar 0.6.5 navigation and workflows for novelty.
- Do not hide errors behind an indefinite loader, vague toast, or silent fallback.
- Do not use neon sci-fi decoration, glassmorphism, excessive gradients, or gratuitous motion.
- Do not imply official upstream endorsement or reuse the original logo without written permission.

## Design Principles

1. Preserve continuity: existing users should immediately recognize the information architecture and controls.
...
Target WCAG 2.2 AA for text contrast, keyboard operation, focus visibility, semantic status announcements, and control labeling. Respect system and in-app reduced-motion preferences. Never communicate health, warning, or failure by color alone. Keep the existing 760 x 600 minimum desktop viewport usable and support keyboard-only recovery from startup failures.
